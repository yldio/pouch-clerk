...
function Clerk(_options) {
  ...
  var asyncUpdaters = this._options.asyncUpdaters;
  if (! Array.isArray(asyncUpdaters)) {
    asyncUpdaters = [asyncUpdaters];
  }

  this._asyncUpdaters = asyncUpdaters.map(function eachUpdater(asyncUpdater) {
